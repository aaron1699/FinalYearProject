...
self.checkBoxListWidget.hide()
self.correctAnswerBox.hide()
self.answerExplanation.hide()
self.answerExplanationInput.hide()
self.minTextLabel.hide()
self.maxTextLabel.hide()
self.minTextInput.hide()
self.maxTextInput.hide()
self.horizontalXLabel.hide()
self.horizontalXInput.hide()
self.verticalYLabel.hide()
self.verticalYLabelInput.hide()
self.XYMax.hide()
self.XYMaxInput.hide()